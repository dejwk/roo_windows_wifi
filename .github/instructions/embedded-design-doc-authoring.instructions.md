---
name: "roo_windows_wifi Rendering Design Authoring"
description: "Additional illustration requirements for geometry and rendering design documents in roo_windows_wifi."
applyTo:
  - "docs/**/*.md"
  - "doc/**/*.md"
---
