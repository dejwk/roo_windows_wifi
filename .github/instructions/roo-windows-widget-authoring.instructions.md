---
name: "roo_windows_wifi Widget Authoring"
description: "Use when editing widget behavior, layout, painting, invalidation, surface ownership, or widget-facing public APIs in roo_windows_wifi. Applies to widget implementations, examples, and tests."
applyTo: "src/roo_windows_wifi/**/*.{c,cc,cpp,h,hh,hpp}, examples/**/*.ino, emulation/main.cpp, test/**/*.cpp"
---
# roo_windows_wifi Widget Authoring

Use this instruction when working on widget behavior in `roo_windows_wifi`:
widget APIs, measurement, layout, painting, invalidation, surface ownership,
input handling, and related tests or examples.

This is the widget-authoring guidance for this repository, copied from
`roo_windows`. Framework source references below are relative to a sibling
`roo_windows` checkout.
...
- `../roo_windows/src/roo_windows/material3/badge/badge.cpp` paints the badge interior and
...
- `../roo_windows/src/roo_windows/material3/slider/slider.cpp` keeps
...
- `../roo_windows/src/roo_windows/core/widget.cpp`
- `../roo_windows/src/roo_windows/core/container.cpp`
...
See `../roo_windows/src/roo_windows/core/container.cpp`, including `fastDrawChildShadow()`.
